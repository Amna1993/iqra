      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="w-full md:w-1/2 flex justify-center">
            <div className="bg-yellow-400 p-4 rounded-lg shadow-xl">
              <img
                src={bio}
                alt="AI Engineer"
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0 md:ml-12">
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
              ...
              communication networks, with expertise in areas such as resource allocation, mobility-aware
              networking, and AI-driven optimization. I work on designing innovative solutions for dynamic
              resource allocation, beamforming, and interference management to improve network
              efficiency and reliability. My work also involves creating synthetic datasets and simulations
              using frameworks like Sionna to model realistic wireless communication scenarios.
            </p>
            <p className="text-lg text-gray-300 mb-6 leading-relaxed">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              As a lecturer, I am passionate about mentoring students and fostering innovation. I integrate
              cutting-edge research insights into my teaching to ensure students are equipped with the
              skills and knowledge needed to excel in the ever-evolving field of computer science. With a
              strong academic background and a track record of impactful research, I am committed to
              contributing to advancements in AI-driven technologies and wireless communication systems,
